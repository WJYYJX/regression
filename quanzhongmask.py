...
if attention_weights is not None:
    ...
    fig_overlay, axes_overlay = plt.subplots(num_channels, num_heads, figsize=(8  * num_heads, 8  * num_channels))
    ...
    for channel_idx in range(num_channels):
        ...
        for head_idx in range(num_heads):
            ...
            attn_map_resized_np = np.array(attn_map_resized) / 255.0  # 归一化到 [0, 1]
            ...
            # 叠加显示
            ax = axes_overlay[channel_idx, head_idx]
    ...
    plt.tight_layout()
    plt.savefig("attention_weights_per_channel_head_overlay.png")
    plt.show()
else:
